...
<img src="Pictures/simple_LR.png" alt="Drawing" style="width: 300px;"/>

Figure 1: Plot of scatter points in 2D space (blue) and line that results in the least error (red). (Source: https://acadgild.com/blog/2linear-regression-case-study-2)
...
<img src="Least_squares.png" alt="Drawing" style="width: 300px;"/>
Figure 2: A plot of the data points (red), the least squares line of best fit (blue), and the residuals (green). Source: Wikipedia, (https://en.wikipedia.org/wiki/Linear_least_squares)
